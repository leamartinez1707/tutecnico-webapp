...
const RenewalModal = ({
  ...
  logger.debug("RenewalModal abierto", {
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-blue-900">
                    ...
                    <p>
                      Tu suscripción será activada una vez que verifiquemos tu
                      pago. Esto puede tomar entre 24-48 horas hábiles.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        handleCopy(BANK_ACCOUNT_INFO.accountNumber, "account")
                      }
                    >
                      {copiedField === "account" ? (
                        <Check className="w-4 h-4 text-green-600" />
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        handleCopy(BANK_ACCOUNT_INFO.holder, "holder")
                      }
                    >
                      {copiedField === "holder" ? (
                        <Check className="w-4 h-4 text-green-600" />
                ...
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-yellow-900">
                    ...
                    <ol className="list-decimal list-inside space-y-1">
                      ...
                      <li>
                        Enviarás la información por WhatsApp con tu comprobante
                      </li>
                    </ol>
                  </div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-green-800">
                      En el siguiente paso podrás enviar tu comprobante
                      directamente por WhatsApp al número:
                    </p>
        ...
        {step === "proof" && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Ingresa los datos de tu transferencia. Se enviará la información
                por WhatsApp junto con tu comprobante.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Ingresa el número de referencia que aparece en tu comprobante
                  bancario
                </p>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-green-900">
                    ...
                    <p>
                      Al hacer clic en "Enviar por WhatsApp", se abrirá una
                      conversación con toda la información ya completada. Solo
                      debes adjuntar la foto de tu comprobante y enviar el
                      mensaje.
                    </p>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={
                  !transactionReference || !transactionDate || isSubmitting
                }
